...
local highlights = {
  ...
  ErrorMsg = { fg = colors.red, bold = true, underline = true },
  ...
  Structure = { fg = colors.none },
  StorageClass = { fg = colors.none },
  Identifier = { fg = colors.none },
  Constant = { fg = colors.light_ligth_grey, bold = true },
  ...
  Conditional = { fg = colors.none },
  Repeat = { fg = colors.none },
  Statement = { fg = colors.none },
  ...
  ["@constant.macro"] = { link = "Constant", default = true },
  ...
  ["@type.builtin"] = { link = "TypeBulitin", default = true },
  ["@type.definition"] = { link = "Typedef", default = true },
  ["@type.qualifier"] = { link = "Type", default = true },
  ["@variable"] = { fg = colors.fg, default = true },
  ["@variable.builtin"] = { fg = colors.light_grey, default = true },
